...
- PRs get a CodeRabbit review, but it must be **triggered by hand**: since
  ~2026-09-08 the free open-source tier does not auto-review a repository with
  fewer than 10 GitHub stars (this one has 0), so `auto_review.enabled: true`
